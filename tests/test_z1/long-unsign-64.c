...
int main() {
	struct function funcs[] = {
		{"get_ptr64", 0, 0, TYPE_UNSIGNED_LONG, get_long64},
		{"get_ptr64", 0, 0, TYPE_UNSIGNED_LONG, get_long32},
		{"get_ptr64", 0, 0, TYPE_UNSIGNED_LONG, get_long_negative},
	};
	
	test(&funcs[0], false, "get_long64");
	test(&funcs[1], true, "get_long32");
	test(&funcs[2], false, "get_long_negative");
	printf("OK\n");
}
